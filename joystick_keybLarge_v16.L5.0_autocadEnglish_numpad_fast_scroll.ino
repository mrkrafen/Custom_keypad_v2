    ...
    for (int i = 0; i < LIST_MAX; i++) // Scan the whole key list.
    {
      if ( kpad.key[i].stateChanged )   // Only find keys that have changed state.
      {
        ...
        if (tasto == '5')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('7');}
              break;
            case IDLE:
              break;
            case HOLD:
        ...
        if (tasto == '8')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('^');} //ho messo il simbolo della potenza perchè è già compatibile con il keycap messo e perchè ha davvero senso su excel
              break;
            case IDLE:
              break;
            case HOLD:
        ...
        if (tasto == '9')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('8');}
              break;
            case IDLE:
              break;
            case HOLD:
        ...
        if (tasto == 'A')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('9');}
              break;
            case IDLE:
              break;
            case HOLD:
        ...
        if (tasto == 'C')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('4');}
              break;
            case RELEASED:
        ...
        if (tasto == 'D')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('5');}
              break;
            case IDLE:
              break;
            case HOLD:
        ...
        if (tasto == 'E')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
              ...
              if (keyFuncState == 1){Keyboard.press('6');}
              break;
            case IDLE:
              break;
            case HOLD:
		...
		if (tasto == 'I')
        {
          switch (kpad.key[i].kstate) {  // Report active key state : IDLE, PRESSED, HOLD, or RELEASED
            case PRESSED:
                if (keyFuncState == 0){Keyboard.press(KEY_LEFT_CTRL);}
                if (keyFuncState == 1){Keyboard.press('0');}
              break;
            case RELEASED:
